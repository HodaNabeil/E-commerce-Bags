...
function CardItem({product}) {
  return (
    ...
    className="  product-item  relative flex justify-center items-center flex-col"
  >
    <div className=" bg-[#ddc2ab52] rounded-[6px] relative overflow-hidden ">
      <img
        className=" w-[200px] h-[200px] p-[20px] object-cover "
        src={product.image[0]}
        alt={product.title}
      />
      <div
    ...
    <div className="  container-box-icon hidden flex-col absolute top-[50px] right-[10px] ">
      <span
        className="  box-icon  duration-500 transition-all  
        relative  w-[40px] h-[40px] element-center-flex  rounded-[50px] color-light 
